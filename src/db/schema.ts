...
export const users = pgTable("users", {
  ...
  telNumber: varchar("tel_number", { length: 20 }).notNull(),
...
export const studentsTable = pgTable("students", {
  ...
  parentPhoneNumber: varchar("parent_phone_number", { length: 20 }).notNull(),
...
export const teachersTable = pgTable("teachers", {
  ...
  status: statusEnum("status").notNull().default("New"),
  teacherPictureFileId: uuid("teacher_picture_file_id")
  // .references(() => filesTable.id, { onDelete: "set null" }),
});
